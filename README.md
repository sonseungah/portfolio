# 다양한 언어와 기술을 배우고 사용하는 것을 즐기는 개발자 손승아 입니다.

## :pushpin: Intro
1. 스마트인재개발원 1040시간 (8개월) 언어지능기반 분석서비스모델 개발자과정 수료
...
3. 국가정보자원관리원 광주센터 근무 :
   - 2025.02 ~ 2026.02 국가자원관리원 정보시스템 1군 클라우드 팀 Openstack풀 운영유지관리
   - 다양한 장애 상황 및 유지관리 효율성 관련 경험
...
<img src="https://img.shields.io/badge/AWS-CC9933?style=for-the-badge&logo=aws&logoColor=white"> <img src="https://img.shields.io/badge/GCP-white?style=for-the-badge&logo=Google&logoColor=black">
...
>HTML / CSS
>
> 실시간으로 CPU, 메모리, GPU, 디스크, 네트워크 상태를 브라우저에서 확인할 수 있는 로컬 대시보드
...
> TypeScript
>
> PC와 모바일에서 모두 사용 가능한 다이어리

## 📌 Education
> 2025.07 ~ 2026.02 오케스트로 근무(클라우드 엔지니어)
> 
